...
# Run `pod lib lint flutter_credit_card_pro.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_credit_card_pro'
  s.version          = '0.0.1'
...
and float.
                       DESC
  s.homepage         = 'https://github.com/simformsolutions/flutter_credit_card_pro'
